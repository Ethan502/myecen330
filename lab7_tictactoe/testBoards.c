...
void testBoards() {
  ...
  board9.squares[MID][LFT] = MINIMAX_O_SQUARE;
  ...
  board9.squares[BOT][MID] = MINIMAX_X_SQUARE;
  ...
  board10.squares[BOT][RGT] = MINIMAX_O_SQUARE;

  tictactoe_board_t board11;
  board11.squares[TOP][LFT] = MINIMAX_EMPTY_SQUARE;
  board11.squares[TOP][MID] = MINIMAX_O_SQUARE;
  ...
  // printBoard(&board15,true);
  // printf("%d",minimax_computeBoardScore(&board15,true));
  // printf("\n\n");
